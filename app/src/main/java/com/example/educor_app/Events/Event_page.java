    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (users != null) {
            if (users.getPhotoUrl() != null) {
                imageUrl=users.getPhotoUrl().toString();
            }else{
                imageUrl="default";
            }
        }
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()) {
                    ...
                    case R.id.homepage:
                        ...
                        return true;
                    case R.id.chat:
                        Intent lntents=new Intent(Event_page.this, StartActivity.class);
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        ref.addValueEventListener(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                ...
                                ref.child("imgUrl").setValue(imageUrl);
                                ...
                                ///notification write on firebase
                                                        ...
                                                        if(class_name.equals(Classnames)){
                                                            ...
                                                            message_ref.addValueEventListener(new ValueEventListener() {
                                                                ...
                                                                public void onDataChange(@NonNull DataSnapshot snapshot) {
                                                                    ...
                                                                    String refkey=message_ref.getKey();

                                                                    message_ref.child("name").setValue(message);
                                                                    message_ref.child("time").setValue(childdate);
                                                                    message_ref.child("message").setValue(posted_msg);
                                                                    message_ref.child("imgUrl").setValue(imageUrl);
                                                                    message_ref.child("isSeen").setValue("false");
                                                                    message_ref.child("refkey").setValue(refkey);
