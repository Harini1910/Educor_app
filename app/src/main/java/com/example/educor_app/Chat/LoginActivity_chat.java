    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        forgot_password.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(LoginActivity_chat.this, ResetPasswordActivity.class));
            }
        });
        ...
        btn_login.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                //Utils.hideKeyboard(LoginActivity_chat.this);

                if (TextUtils.isEmpty(txt_email) || TextUtils.isEmpty(txt_password)){
                    Toast.makeText(LoginActivity_chat.this, "All fields are required", Toast.LENGTH_SHORT).show();
                } else {

                    //dialog = Utils.showLoader(LoginActivity_chat.this);
                            ...
                            .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                                ...
                                public void onComplete(@NonNull Task<AuthResult> task) {
                                    if (task.isSuccessful()){
                                        ...
                                        Toast.makeText(LoginActivity_chat.this, "Authentication failed!", Toast.LENGTH_SHORT).show();
