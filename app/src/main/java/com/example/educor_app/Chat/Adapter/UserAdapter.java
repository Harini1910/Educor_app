package com.example.educor_app.Chat.Adapter;
...
import com.example.educor_app.Chat.MessageActivity;
...
public class UserAdapter extends RecyclerView.Adapter<UserAdapter.ViewHolder> {
    ...
    public UserAdapter(Context mContext, OnItemClick onItemClick, List<User> mUsers,String Classname, boolean ischat){
    ...
    private void lastMessage(final String userid, final TextView last_msg){
        ...
        DatabaseReference reference = FirebaseDatabase.getInstance().getReference("Chats").child(Classname);
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for (DataSnapshot snapshot : dataSnapshot.getChildren()){
                   ...
                   if (firebaseUser != null && chat != null) {
                        if (chat.getReceiver().equals(firebaseUser.getUid()) && chat.getSender().equals(userid) ||
                            ...
                            isSender=chat.getSender().toString();
                        }
                    }
                }
                ...
                switch (theLastMessage){
                    ...
                    default:
                        if(isSender.equals(firebaseUser.getUid())){
                            ...
                            if(isSeen){
                                ...
                                last_msg.setText(theLastMessage);
                                last_msg.setTextColor(Color.parseColor("#038ECF"));
                            }
                        }
